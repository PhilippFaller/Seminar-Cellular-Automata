...
\begin{itemize}
	\item[$N$] ist eine endliche, nicht leere Menge aus Knoten.
	...
	\item[$g$] $: A \rightarrow Z_d$ ist eine Abbildung, wobei $Z_d = \{1, 2,, d \}$, die folgende Eigenschaften besitzt:
	
	Sei für $n \in N$ $A_n := \{\left(n, m\right) \in A\}$ die Menge aller Kanten, die von $n$ ausgehen.
	\begin{enumerate}
